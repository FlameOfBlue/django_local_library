...
# SECRET_KEY = 'django-insecure-mqa=&v!517m*xe6gt#c*&!ur1y1a=r3@=s8stub)c_=d#zj*5g'
import os 
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-mqa=&v!517m*xe6gt#c*&!ur1y1a=r3@=s8stub)c_=d#zj*5g')
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Project to deal with static files efficiency 
