...
from django.contrib.auth.models import User # Required to assign User as a borrower in Book Instance 
...
class Book(models.Model):
    ...
    # Because we have genre class defined so we can specify the object 
    # Update language into Book Class 
